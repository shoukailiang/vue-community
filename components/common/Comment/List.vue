    ...
    <div v-for="(item, index) in commentList" class="hbl-child" :key="index">
      ...
      <div class="content">
        ...
        <div class="reply-content">
          ...
          <div
            class="cc markdown-body"
            v-html="
              analyzeEmoji(item.content ? item.content : item.htmlContent)
            "
          ></div>
        </div>
            ...
            <div v-if="buttonMap[index]" class="hbl-owo">
              ...
              <div class="publish publish-btn">
                ...
                <el-button
                  ...
                  >发 布</el-button
                >
                <el-button @click="cancel(index)" size="mini" round
                  >取 消</el-button
                >
              </div>
            </div>
